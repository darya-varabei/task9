...
struct FillingData {
    static let data: [ContentType] = [
        ...
        .gallery(Gallery(coverImage: .init("terrikon-0"), title: "Soligorsk", images: .init(base: "terrikon", count: 6))),
        .gallery(Gallery(coverImage: .init("cat-0"), title: "Berta", images: .init(base: "cat", count: 5))),
